...
class AdminController{
	static $default_config = array(
	  ...
	  'drawer_img' => 'https://cdn.jsdelivr.net/gh/moeYuiYui/oneindex@1.0.0/img/1.jpg',
	  'icon_url' => 'https://cdn.jsdelivr.net/gh/moeYuiYui/oneindex@1.0.0/img/icon.png',
	  'password' => 'oneindex',
	  'style'=>'material',
	  'api_url'=>'',
	  'onedrive_root' =>'',
	  ...
	  'show'=> array (
	    ...
	    'video5'=>[],
	    'video'=>['mpg', 'mpeg', 'mov', 'wmv', 'mp4', 'webm', 'mkv', 'flv', 'ts', 'm3u8'],
	    'video2'=>['avi', 'rm', 'rmvb', 'asf'],
	    'audio'=>['ogg','mp3','wav','ape','aac','m4a','alac','flac'],
	    'code'=>['html','htm','php', 'css', 'go','java','js','json','txt','sh','md','txt'],
	...
	function settings(){
		...
		if($_POST){
			...
			config('icon_url',$_POST['icon_url']);
		}
