	...
	<div class="mdui-typo">
      <h4 class="doc-article-title">
	    填入<code>client_id</code>和<code>client_secret</code>,
      	<a href="https://portal.azure.com" target="_blank" class="mdui-btn mdui-color-theme-accent mdui-ripple"><i class="mdui-icon material-icons">&#xe89e;</i> 进入国际版Azure注册应用</a>
      	<a href="https://portal.azure.cn" target="_blank" class="mdui-btn mdui-color-theme-accent mdui-ripple"><i class="mdui-icon material-icons">&#xe89e;</i> 进入世纪互联版Azure注册应用</a>
      </h4>
    </div>

	<form action="" method="post">
		<div class="mdui-textfield">
		<label class="mdui-textfield-label">OneDrive版本</label>
			...
			<label class="mdui-radio">
    			...
    			<i class="mdui-radio-icon"></i>世纪互联版
			</label>
		</div>
